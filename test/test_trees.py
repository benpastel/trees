...
#   #   then remove global X -= np.mean(X)
...
#   assert_array_almost_equal(tree.intercepts,     [np.mean(y), 0])
...
#   assert_array_almost_equal(tree.intercepts, [10, -8.25, -3.5, 10, -1.75, 0.25, 1.25])
